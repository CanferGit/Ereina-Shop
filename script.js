...
// Klick außerhalb schließt Impressum
...
// Wichtig: Nur EINMAL beim Laden prüfen!
window.addEventListener('DOMContentLoaded', () => {
  if (localStorage.getItem('isOver18') !== 'true') {
    checkAge(); // Erst Altersprüfung, dann ggf. Seite laden!
  } else {
    document.getElementById('ageModal').style.display = 'none';
    if (typeof load === 'function') load(); // Direkt laden, wenn bestätigt
  }

  // Cookie-Hinweis bleibt wie gehabt
